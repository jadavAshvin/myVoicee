...
import 'package:my_voicee/postLogin/Topics/topicbloc/TopicsDataRepository.dart';
import 'package:rxdart/rxdart.dart';

class TopicsBloc with ApiCallback {
  final StreamController apiController;
  final StreamController apiController2;
  TopicsDataRepository _dataProvider;

  TopicsBloc(this.apiController, [this.apiController2]) {
    _dataProvider = TopicsDataRepository(this);
  }
