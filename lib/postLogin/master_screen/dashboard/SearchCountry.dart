...
class SearchCountry extends StatefulWidget {
  ...
  @override
  SearchCountryState createState() => SearchCountryState();
}

class SearchCountryState extends State<SearchCountry> {
  String query = '';
  var _inputController = TextEditingController();
  var _blankFocusNode = FocusNode();
  List<Countries> countryList = List<Countries>();
  ...
  void callApiGetProjects(String query) {
    List<Countries> queryList = List<Countries>();
  ...
  Widget buildList(List<Countries> countryList) {
