...
class _DashBoardListItemState extends State<DashBoardListItem> {
  ...
  @override
  void initState() {
    if (isShowTut && (widget.pos == 0) && !widget.isShown)
                      ...
                      ? Row(
                          ...
                          children: <Widget>[
                            ...
                            InkWell(
                              key: _key3,
                              onTap: () =>
                                  widget.callBack.onReplyClick(widget.pos),
                              child: Padding(
                                padding: const EdgeInsets.all(4.0),
                                child: Row(
                                  children: <Widget>[
                                    Image.asset(
                                      '$ic_replies',
                                      color: widget.data.is_commented
                                          ? appColor
                                          : colorGrey2,
                                    ...
                                    Text(
                                      widget.data.n_comments > 0
                                          ? ' ${widget.data.n_comments}'
                                          : '',
                                      style: TextStyle(
                                        fontFamily: 'Roboto',
                                        fontSize: widget.fit.t(12.0),
                            ...
                            InkWell(
                              key: _key4,
                              onTap: () =>
                                  widget.callBack.onShareClick(widget.pos),
                              child: Padding(
                                padding: const EdgeInsets.all(4.0),
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Text(
                                      widget.data.n_shares > 0
                                          ? ' ${widget.data.n_shares}'
                                          : '',
                                      style: TextStyle(
                                          fontFamily: 'Roboto',
                                          fontSize: widget.fit.t(12.0),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        Text(
                                          widget.data.n_dislikes > 0
                                              ? ' ${widget.data.n_dislikes}'
                                              : '',
                                          style: TextStyle(
                                              fontFamily: 'Roboto',
                                              fontSize: widget.fit.t(12.0),
