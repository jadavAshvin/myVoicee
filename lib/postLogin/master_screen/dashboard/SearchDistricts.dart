...
class SearchDistricts extends StatefulWidget {
  final List<District> countryList;

  SearchDistricts(this.countryList);

  @override
  SearchDistrictsState createState() => SearchDistrictsState();
}

class SearchDistrictsState extends State<SearchDistricts> {
  String query = '';
  var _inputController = TextEditingController();
  List<District> countryList = List<District>();
  List<District> dummyListData = List<District>();
  ...
  void callApiGetProjects(String query) {
    List<District> queryList = List<District>();
  ...
  Widget buildList(List<District> countryList) {
