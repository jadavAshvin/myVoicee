...
class ProfileDataRepo {
  ...
  ProfileDataRepo(this.apiCallback);
  ...
  void callApiAllPost(BuildContext context, String userId, int page) {
    checkInternetConnection().then((onValue) {
      !onValue
          ? apiCallback.onAPIError(
              CustomError('Check your internet connection.'), NO_INTERNET_FLAG)
          : _onCallApiAllPost(context, userId, page);
    });
  }
  ...
  void apiVerifyOTP(BuildContext context, String number, String otp) {
    checkInternetConnection().then((onValue) {
      !onValue
          ? apiCallback.onAPIError(
              CustomError('Check your internet connection.'), NO_INTERNET_FLAG)
          : _apiVerifyOTP(context, number, otp);
    });
  }
  ...
  void apicallApiResendOtp(BuildContext context, String phone) {
    checkInternetConnection().then((onValue) {
      !onValue
          ? apiCallback.onAPIError(
              CustomError('Check your internet connection.'), NO_INTERNET_FLAG)
          : _apiapicallApiResendOtp(context, phone);
    });
  }
