...
class _FollowingsScreenState extends State<FollowingsScreen> {
  ...
  void initState() {
    ...
    apiSuccessResponseController =
        StreamController<List<Following>>.broadcast();
    _bloc = ProfileBloc(apiResponseController, apiSuccessResponseController);
    _bloc.getFollowingsList(context);
        ...
        children: [
          Container(
            ...
            padding: EdgeInsets.only(
                ...
                left: fit.t(16.0),
                right: fit.t(16.0)),
            child: StreamBuilder<List<Following>>(
                  ...
                  return ListView.separated(
                    itemBuilder: (context, index) {
                      return ListTile(
                        ...
                        leading: snapshot.data[index].user == null
                            ? Container(
                                width: fit.t(45.0),
                                height: fit.t(45.0),
                            ...
                            : snapshot.data[index].user.dp == null ||
                                ...
                                : snapshot.data[index].user.dp.contains('http')
                                    ? Container(
                                        width: fit.t(45.0),
                                        height: fit.t(45.0),
                                        decoration: BoxDecoration(
